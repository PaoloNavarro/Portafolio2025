...
import SearchComponent from '../common/SearchComponent'; // Import the new component
import { useTheme } from '@/hooks/useTheme';

interface HeaderProps {
  onToggleMenu: () => void;
  // onToggleSearch is no longer needed as it will be handled internally
}
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center space-x-4 order-last md:order-last">
          ...
          <button
            onClick={handleToggleSearch} // Use the new handler
      ...
      <SearchComponent isOpen={isSearchOpen} onClose={handleToggleSearch} />
    </>
  );
};
